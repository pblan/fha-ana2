...
\begin{questions}
            ...
            $$
                \begin{aligned}
                    \frac{\mathrm{d} k}{\dx} & = \ddx \frac{1}{\tan(\arcsin(x))}                                                                                                             \\
                                             ...
                                             & =\footnote{$\cos(x) = \sqrt{1-\sin^2(x)} \implies \cos(\arcsin(x)) = \sqrt{1-\sin^2(\arcsin(x))} = \sqrt{1-x^2}$} \ddx \frac{\sqrt{1-x^2}}{x} \\
    ...
    \begin{parts}
        ...
        \begin{solution}
            $$
                \begin{aligned}
                    \frac{\partial f}{\partial x} & = \frac{\partial}{\partial x} \arctan\left(\frac{y}{x}\right)
                    = -\frac{y}{x^2} \cdot  \frac{1}{\left(\frac{y}{x}\right)^2 + 1} = -\frac{y}{x^2\left(\frac{x^2 + y^2}{x^2}\right)} = -\frac{y}{x^2 + y^2} \\
                    \frac{\partial f}{\partial y} & = \frac{\partial}{\partial y} \arctan\left(\frac{y}{x}\right)
                    = \frac{1}{x} \cdot        \frac{1}{\left(\frac{y}{x}\right)^2 + 1}   = \frac{1}{x\left(\frac{x^2 + y^2}{x^2}\right)} = \frac{x}{x^2 + y^2}
                \end{aligned}
            $$\qed
        \end{solution}
